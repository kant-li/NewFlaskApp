...
from app.utils.utils import successful_response, error_response, valid_email_address, generate_verification_code
...
def send_verification_code():
    ...
    return successful_response(message="A verification code has been sent to your email. Expire in 30 minutes.")
