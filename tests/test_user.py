...
from tests.constants import TEST_EMAIL, TEST_PASSWORD, TEST_USERNAME, SEND_VERIFICATION_CODE_URL, REGISTER_URL, LOGIN_URL, TOKEN_TEST_URL


@mark.user
def test_send_verification_code(client: fixture, mock_verification_code_email: fixture, clear_db: fixture) -> None:
...
@mark.user
def test_register(client: fixture, mock_verification_code_email: fixture, clear_db: fixture, init_db: fixture) -> None:
    # 获取验证码
    ...
    # 尝试注册
    post_data = {'verification_code': code, 'email': TEST_EMAIL, 'password': TEST_PASSWORD, 'username': TEST_USERNAME}
...
@mark.user
def test_login(client: fixture, mock_verification_code_email: fixture, clear_db: fixture, insert_test_user: fixture):
    # 尝试登录
